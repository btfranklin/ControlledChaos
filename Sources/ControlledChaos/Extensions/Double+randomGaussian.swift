...
extension Double {
    ...
    public static func randomGaussian<G: RandomNumberGenerator>(withStandardDeviation standardDeviation: Double = 1.0,
        ...
        repeat {
            ...
            if let gaussian = Double._queudGaussian {
                ...
                repeat {
                    value1 = 2 * Double.random(in: 0...1, using: &generator) - 1
                    value2 = 2 * Double.random(in: 0...1, using: &generator) - 1
    ...
    public static func randomGaussian(withStandardDeviation standardDeviation: Double = 1.0,
        ...
        return randomGaussian(withStandardDeviation: standardDeviation,
                              withMean: mean,
                              withMaximum: maximum,
                              withMinimum: minimum,
